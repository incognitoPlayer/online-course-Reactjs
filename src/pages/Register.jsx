        ...
        >
          <form className="max-w-lg mx-auto" onSubmit={handleSubmit}>
            ...
            <div className="flex mt-5">
              <Checkbox />
              <p className="text-sm font-medium mr-1" href="/">
                I Accept
              </p>
              <a
                href="/"
                className="text-sm font-medium text-primaryColor underline mr-1"
              >
                Term & Conditions
              </a>
              <p className="text-sm font-medium mr-1" href="/">
            ...
            <div className="mt-8 ">
              <button
                className="bg-primaryColor hover:bg-[#f05d27] text-white py-2 px-4 rounded-full w-full text-base font-medium"
                type="submit"
              >
                Register
              </button>
